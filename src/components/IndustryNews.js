        ...
        <div className='max-w-7xl text-center self-center'>
          ...
          <div className='flex flex-col md:flex-row gap-x-4 mt-6'>
            <div className="max-w-sm rounded overflow-hidden mt-5 shadow-lg">
              <Image className="w-full" src="/news/news-1.jpg" height={100} width={100} alt="Sunset in the mountains" />
            ...
            <div className="max-w-sm rounded overflow-hidden mt-5 shadow-lg">
              <Image className="w-full" src="/news/news-2.jpg" height={100} width={100} alt="Sunset in the mountains" />
              <div className="px-6 py-4">
                <div className="font-bold text-sm md:text-xl mb-2">UNPACKING THE DEMAND OF THE UK COURIER</div>
                <p className="text-gray-700 text-xs ">
            ...
            <div className="max-w-sm rounded overflow-hidden mt-5 shadow-lg">
              <Image className="w-full" src="/news/news-3.jpg" height={100} width={100} alt="Sunset in the mountains" />
              <div className="px-6 py-4">
                <div className="font-bold text-sm md:text-xl mb-2">COURIER AND EXPRESS DELIVERY MARKET POSTS £1 BILLION INCREASE IN SALES IN 2016</div>
                <p className="text-gray-700 text-xs ">
            ...
            <div className="max-w-sm rounded overflow-hidden mt-5 shadow-lg">
              <Image className="w-full" src="/news/news-4.png" height={100} width={100} alt="Sunset in the mountains" />
              <div className="px-6 py-4">
                <div className="font-bold text-sm md:text-xl mb-2">UK COURIER MARKET SURGES AS E-SHOPPING BOOMS – MINTEL</div>
                <p className="text-gray-700 text-xs ">
