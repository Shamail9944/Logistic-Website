...
export default function MiniHeaderPri() {
  return (
    <div className='hidden lg:block w-full bg-[#6C0287]'>
      <div className="mx-auto max-w-5xl flex items-center pt-2 justify-between text-white font-bold align-middle">
        <div className='flex gap-x-5'>
          <div className="flex flex-row gap-x-2 ">
            <GiRotaryPhone className='text-[#FDAF17] text-lg' />
            <p className="hover:text-[#FDAF17] transition-all duration-300 text-xs font-thin-">03xx xxxxxxx</p>
          </div>
          <div className="flex flex-row gap-x-2">
            <SlEnvolopeLetter className='text-[#FDAF17] text-lg' />
            <p className="hover:text-[#FDAF17] transition-all duration-300 text-xs font-thin-">info@VivoCouriers.co.uk</p>
          </div>
        </div>
        <div className='flex gap-x-5 lg:justify-end'>
          <div className="flex flex-row gap-x-2">
            <FaHouseSignal className='text-[#FDAF17] text-lg' />
            <p className="hover:text-[#FDAF17] transition-all duration-300 text-xs font-thin-">Subscribe</p>
          </div>
