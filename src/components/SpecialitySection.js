    ...
    return (
        <div className='bg-[#FFFFFF] '>
            ...
            <div className='bg-[#ccccccbb] text-black mx-auto max-w-8xl flex flex-col items-center px-6 lg:px-4 py-2 lg:py-10 justify-between'>
                <div className='max-w-xl md:max-w-5xl text-center self-center'>
                ...
                <div className=' flex flex-col md:flex-row gap-x-16 mt-5 md:mt-16 max-w-6xl'>
                    ...
                    <div className='lg:flex-1 text-xs flex flex-col gap-x-6 '>
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><BsBoxes /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><BsClockFill /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><MdGpsFixed /></div>
                            <p className='mb-2 md:mb-5 font-bold text-sm md:text-xl max-w-xs text-center self-center'>We operate on a 24 hour, 7 days a week courier service</p>
                        </div>
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><AiFillIdcard /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><FaClipboardList /></div>
                    ...
                    <div className='lg:flex-1 text-xs flex flex-col gap-x-6'>
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><FaTruck /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><HiClipboardDocumentList /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><BsFillBuildingFill /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><BsPersonFill /></div>
                        ...
                        <div className='flex flex-col md:flex-row gap-x-6'>
                            <div className='mb-3 md:mb-20 font-bold text-3xl md:text-7xl text-yellow-500 self-center'><MdFactory /></div>
