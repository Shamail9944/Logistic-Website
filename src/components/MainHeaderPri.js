...
export default function MainHeaderPri() {
  ...
  return (
    <header className="bg-[#6C0287] text-white sticky top-0 z-50">
      <div>
        <nav className="mx-auto flex max-w-5xl items-center justify-between pb-2 px-4 lg:px-0 " aria-label="Global">

          {/* Logo and Title Lg Screen */}
          {!mobileMenuOpen && <div className="flex lg:flex-1 pl-2">
            <Link href="/" className="-m-3 p-1 flex flex-row gap-x-3">
              <div className="flex flex-rowitems-start md:items-start gap-x-2">
                <div className="flex flex-col mt-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-auto h-12">
                    <path d="M3.375 4.5C2.339 4.5 1.5 5.34 1.5 6.375V13.5h12V6.375c0-1.036-.84-1.875-1.875-1.875h-8.25zM13.5 15h-12v2.625c0 1.035.84 1.875 1.875 1.875h.375a3 3 0 116 0h3a.75.75 0 00.75-.75V15z" />
                    <path d="M8.25 19.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0zM15.75 6.75a.75.75 0 00-.75.75v11.25c0 .087.015.17.042.248a3 3 0 015.958.464c.853-.175 1.522-.935 1.464-1.883a18.659 18.659 0 00-3.732-10.104 1.837 1.837 0 00-1.47-.725H15.75z" />
                    <path d="M19.5 19.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0z" />
                  </svg>
                </div>
                <div className='flex flex-col mt-2 text-md font-bold text-[#ffffff]'>
                  <span className='text-[#FDAF17]'>Vivo</span>
                  Courier
                </div>
              </div>
            </Link>
          ...
          <div className="flex lg:hidden">
            <button
              type="button"
              className="-m-2.5 inline-flex items-center justify-center rounded-md py-[32px] text-gray-700"
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          {/* Mobile menu - Logo/ title + Close Button */}
          <div className="flex items-center justify-between bg-[#6C0287] px-6 py-4">
