  ...
  return (
    <div className='bg-[#FFFFFF] w-full'>
      ...
      <div className='bg-[#DBE0D8]'>
        <div className='text-black mx-auto max-w-5xl flex flex-col items-center px-6 lg:px-0 py-4 lg:py-8 justify-between'>
          <div className=' flex flex-col gap-x-4 mt-6 max-w-md md:max-w-5xl '>
