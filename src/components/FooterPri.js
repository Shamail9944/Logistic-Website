    ...
    <footer className='flex flex-col bg-[#DCF3F7]'>
      ...
      <div className='text-black mx-auto max-w-4xl flex flex-col md:flex-row w-full gap-x-5 items-start px-6 lg:px-4 py-4 lg:py-8 justify-between'>
        ...
        <div className="flex flex-col lg:flex-1">
          ...
          <Link href="/about" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>About</Link>
          <Link href="/services" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Services</Link>
          <Link href="/fleet" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Fleet</Link>
          <Link href="/network" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Network</Link>
          <Link href="/quotation" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Quotation</Link>
          <Link href="/contact" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Contact</Link>
        </div>
        <div className="flex flex-col lg:flex-1">
          <h3 className='font-bold'>Connect</h3>
          <Link href="/" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>XXX Couriers Pvt Ltd</Link>
          <Link href="/" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Tel - XXXX XXXXXXX</Link>
          <Link href="/" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>Cell - XXXX XXXXXXX</Link>
          <Link href="/" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>info@XXXCouriers.co.uk</Link>
          <Link href="/" className='font-bold text-xs mt-2 hover:text-[#6C0287] text-gray-600'>quotes@XXXCouriers.co.uk</Link>
